...
/**
 * EmployeeSearch represents the model behind the search form about `common\models\EmployeePost`.
 */
class EmployeeSearch extends EmployeePost
{
    /**
     * @inheritdoc
     */
