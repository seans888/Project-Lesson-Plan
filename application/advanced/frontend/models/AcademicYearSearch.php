...
/**
 * AcademicYearSearch represents the model behind the search form about `common\models\AcademicYearPost`.
 */
class AcademicYearSearch extends AcademicYearPost
{
    /**
     * @inheritdoc
     */
